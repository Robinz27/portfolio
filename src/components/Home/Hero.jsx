        ...
        <div className="text-center">
          ...
          >
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight">
              <span className="block text-gray-900 dark:text-gray-100">สวัสดี, ผมนั้น</span>
          ...
          >
            จัดทำเว็บไซต์นี้เพื่อแสดงผลงาน และเป็นที่รวมของผลงานที่ผมได้ทำไว้ในสำหรับแสดงผลงานของตัวเอง
            ซึ่งกำลังเริ่มต้นการเป็นนักพัฒนาเว็บไซต์, แอพลิเคชั่น, และอื่นๆ
          </motion.p>
          ...
          >
            {[
              ...
              { Icon: FiInstagram, href: 'https://www.instagram.com/aden_7274?igsh=MWxsdzRmOGxwOHJqOA==', label: 'Instagram' },
